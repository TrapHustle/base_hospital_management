...
################################################################################
{
    ...
    "depends": ["website", "hr", "stock", "sale_management", "purchase", "portal", "iap"],
    "data": [
        ...
        "data/hospital_category_data.xml",
        "data/hospital_service_products_data.xml",
        "data/hospital_consumable_data.xml",
        "data/hospital_pricelist_data.xml",
        "data/hospital_insurance_data.xml",
        ...
        "views/hospital_imaging_views.xml",
        "views/hospital_transfer_views.xml",
        "views/hospital_certificate_views.xml",
        ...
        "views/hospital_portal_templates.xml",
        "views/public_site_templates.xml",
        "views/teleconsultation_templates.xml",
        "views/hospital_documents_views.xml",
        "report/csf_report_header.xml",
        "report/res_partner_reports.xml",
        "report/hospital_fiche_reports.xml",
        "report/lab_test_line_reports.xml",
        "report/hospital_transfer_reports.xml",
        "report/hospital_imaging_reports.xml",
        "report/hospital_certificate_reports.xml",
        "report/sale_proforma_reports.xml",
    ],
    "demo": ["demo/hr_job_demo.xml", "demo/hospital_demo.xml"],
    "assets": {
        "web.assets_frontend": [
        ...
        "web.assets_backend": [
            ...
            "base_hospital_management/static/src/js/teleconsult_notification.js",
