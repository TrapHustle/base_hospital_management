...
################################################################################
{
    ...
    "data": [
        ...
        "views/frontend_dashboards_templates.xml",
    ...
    "assets": {
        "web.assets_frontend": [
            ...
            # Frontend-decoupled dashboards - API Helper
            "base_hospital_management/static/src/js/hospital_api_helper.js",
            # Frontend-decoupled dashboards - CSS
            ...
            # Frontend-decoupled dashboards - JS
            "base_hospital_management/static/src/js/doctor_dashboard_frontend.js",
            "base_hospital_management/static/src/js/lab_dashboard_frontend.js",
            "base_hospital_management/static/src/js/pharmacy_dashboard_frontend.js",
            "base_hospital_management/static/src/js/reception_dashboard_frontend.js",
            "base_hospital_management/static/src/js/hospital_portal_frontend.js",
        ],
        "web.assets_backend": [
            "base_hospital_management/static/src/css/doctor_dashboard.css",
            "base_hospital_management/static/src/css/reception_dashboard.css",
